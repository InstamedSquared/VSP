...
const tableService = createResourceService('clients');
...
const Clients = () => {
    ...
    const tableColumns = React.useMemo(() => [
        {
            key: 'fn', label: 'Client Name', type: 0, sortable: true, render: (item, photoUrl) => {
    ...
    return (
        <DataTable
            ...
            config={{ 
                searchables: ['fn|mn|sn', 'fn|sn', 'sn|fn|mn', 'phone', 'email'], 
                title: <span><h2>Client Point of Contacts</h2><p>Manage external client contacts</p></span>, 
                modalWidth: 'w-mm', 

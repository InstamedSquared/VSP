...
const tableService = createResourceService('employees');
...
const Employees = () => {
    ...
    const tableColumns = React.useMemo(() => [
        {
            key: 'fn', label: 'Employee Name', type: 0, sortable: true, render: (item, photoUrl) => {
    ...
    return (
        <DataTable
            ...
            config={{ 
                ...
                title: <span><h2>Employees</h2><p>Manage internal staff and employees</p></span>, 
                modalWidth: 'w-mm', 
